...
Route::middleware('auth')->group(function () {
    ...
    Route::group(['prefix' => 'report'], function () {
        ...
        Route::get('/transaction/cashflow/get-records-datatable', [CashController::class, 'datatableListLedger']);
        ...
        Route::get('/transaction/bank-flow/get-records-datatable', [BankController::class, 'datatableListBankflow']);
    ...
    Route::group(['prefix' => 'import'], function () {
       Route::get('/items', [ImportController::class, 'items'])
        ...
        Route::get('/database', [ImportController::class, 'database'])->name('import.database');
        Route::post('/export-database', [ImportController::class, 'exportDatabase'])->name('import.database.export');
        Route::post('/database/upload', [ImportController::class, 'importDatabase'])->name('import.database.upload');
    ...
    Route::group(['prefix' => 'transaction'], function () {
        ...
        Route::get('/get/cash-in-hand', [CashController::class, 'returnCashInHandValue']);
         ...
         Route::post('/bank/store', [BankController::class, 'storeBankTransaction'])->name('bank.transaction.store');//Save operation

        //get Cash Adjustment details
        Route::get('/bank/adjustment/get/{id}', [BankController::class, 'getBankAdjustmentDetails']);
        //Return only value
        Route::get('/get/cash-in-bank', [BankController::class, 'returnCashInBankValue']);
        ...
        Route::get('/cash/datatable-list', [CashController::class, 'datatableList']);

        Route::get('/cash/datatable-list-transaction', [CashController::class, 'datatableListLedger']);
        Route::get('/bank/datatable-list-transaction', [BankController::class, 'datatableListBankflow']);
        ...
        Route::get('/bank/list', [BankController::class, 'list'])
         ...
         Route::post('/delete/bank', [BankController::class, 'delete'])->name('bank.transaction.delete');//delete operation
