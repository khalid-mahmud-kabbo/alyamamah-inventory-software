...
<body onload="window.print();">
    ...
    <div class="invoice-container">
        <span class="invoice-name">{{ __('print.payment_receipt') }}</span>
        <div class="invoice">
            <table class="header">
                <tr>
            ...
            <table class="addresses">
                <tr>
                    <td class="address">
                        <span class="fw-bold cu-fs-18">{{ __('print.received_from') }}</span><br>
                        <span>{{ $payment->party->first_name.' '. $payment->party->last_name }}<br>
