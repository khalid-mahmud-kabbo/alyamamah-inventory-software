        ...
        <div class="invoice">
            <table class="header">
                <tr>
                    ...
                    <td class="bill-info">
                        <span class="bill-number">{{ __('print.bill') }} #: {{ $sale->sale_code }}</span><br>
                        <span class="cu-fs-16">{{ __('print.date') }}: {{ $sale->formatted_sale_date }}</span><br>
                        <span class="cu-fs-16">{{ __('print.time') }}: {{ $sale->format_created_time }}</span><br>
                        @if($sale->reference_no)
                        <span class="cu-fs-16">{{ __('print.supplier_invoice_number') }}: {{ $sale->reference_no  }}</span><br>
                        @endif
                        @if($sale->sale_order_id)
                        <span class="cu-fs-16">{{ __('print.order') }}: {{ $sale->saleOrder->order_code  }}</span><br>
                        @endif
                    </td>
                </tr>
            </table>
            <table class="addresses">
                <tr>
                    <td class="address">
                        <span class="fw-bold cu-fs-18">{{ __('print.bill_to') }}</span><br>
                    ...
                    <td class="address">
                        <span class="fw-bold cu-fs-18">{{ __('print.ship_to') }}</span><br>
            ...
            <tfoot>
                ...
                <tr>
                    <td colspan="{{ $noteColumns }}" rowspan="{{$noteRosSpan}}" class="tfoot-first-td">
                        <span class="invoice-note">{{ __('print.note')}}:<br></span>{{ $sale->note }}
                    </td>
                ...
                <tr>
                    <td colspan="{{ $noteColumns }}" rowspan="{{ $amountInWordsRowSpan }}" class="tfoot-first-td">
                        <b>{{ __('print.amount_in_words') }}:<br></b>
                ...
                @if(app('company')['is_enable_secondary_currency'])
                    <tr>
                        <td colspan="2" class="text-end fw-bold">{{ __('print.converted_to').'-'.$sale->currency->code }}</td>
                ...
                <tr>
                    ...
                    <td colspan="2" class="text-end fw-bold">{{ __('print.previous_due') }}</td>
