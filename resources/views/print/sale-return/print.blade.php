    ...
    <div class="invoice-container">
        ...
        <div class="invoice">
            <table class="header">
                <tr>
                    ...
                    <td class="bill-info">
                        ...
                        <span class="cu-fs-16">{{ __('print.return_date') }}: {{ $sale->formatted_return_date  }}</span><br>
                        <span class="cu-fs-16">{{ __('print.time') }}: {{ $sale->format_created_time }}</span><br>
                        @if($sale->reference_no)
                        <span class="cu-fs-16">{{ __('print.sale_invoice_number') }}: {{ $sale->reference_no  }}</span><br>
                        @endif
                    </td>
                </tr>
            </table>
            <table class="addresses">
                <tr>
                    <td class="address">
                        <span class="fw-bold cu-fs-18">{{ __('print.return_to') }}</span><br>
