        ...
        <div class="invoice">
            <table class="header">
                <tr>
                    ...
                    <td class="bill-info">
                        <span class="bill-number">{{ __('print.quotation') }} #: {{ $quotation->quotation_code }}</span><br>
                        <span class="cu-fs-16">{{ __('print.date') }}: {{ $quotation->formatted_quotation_date  }}</span><br>
                        <span class="cu-fs-16">{{ __('print.time') }}: {{ $quotation->format_created_time }}</span><br>
            ...
            <table class="addresses">
                <tr>
                    <td class="address">
                        <span class="fw-bold cu-fs-18">{{ __('print.quotation_for') }}</span><br>
                        <span>{{ $quotation->party->first_name.' '. $quotation->party->last_name }}<br>
            ...
            <tfoot>
                ...
                <tr>
                    <td colspan="{{ $noteColumns }}" rowspan="{{$noteRosSpan}}" class="tfoot-first-td">
                        <span class="invoice-note">{{ __('print.note') }}:<br></span>{{ $quotation->note }}
                    </td>
                ...
                @if(app('company')['is_enable_secondary_currency'])
                    <tr>
                        <td colspan="2" class="text-end fw-bold">{{ __('print.converted_to').'-'.$quotation->currency->code }}</td>
                ...
                <tr>
                    ...
                    @endphp
                    <td colspan="2" class="text-end fw-bold">{{ __('print.previous_due_balance') }}</td>
