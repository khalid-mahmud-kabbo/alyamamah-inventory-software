...
<body>
    <div class="invoice-wrapper">
        <div class="container mt-3">
            ...
            <div class="row">
                <div class="col-6">
                    <div>{{ __('print.name') }}: {{ $purchase->party->first_name.' '. $purchase->party->last_name }}</div>
                    <div>{{ __('print.mobile') }}: {{ $purchase->party->mobile }}</div>
                    <div>{{ __('print.seller') }}: {{ $purchase->user->first_name.' '. $purchase->user->last_name }}</div>
                </div>
                <div class="col-6 text-end">
                    <div>{{ __('print.invoice') }}: #SL0040</div>
                    <div>{{ __('print.date') }}: {{ $purchase->formatted_purchase_date  }}</div>
                    <div>{{ __('print.time') }}: {{ $purchase->format_created_time  }}</div>
                </div>
            </div>
            ...
            <table class="table table-sm mt-2">
                ...
                <tbody>
                    ...
                    <tr class="text-end fw-bold">
                        <td colspan="3">{{ __('print.total') }}</td>
            ...
            <div class="row text-end">
                ...
                @endphp
                <div class="col-8 text-end"><strong>{{ __('print.subtotal') }}</strong></div>
                ...
                <div class="col-8 text-end"><strong>{{ __('print.round_off') }}</strong></div>
