            ...
            <table class="header">
                <tr>
                    ...
                    <td class="bill-info">
                        ...
                        <span class="cu-fs-16">{{ __('print.return.date') }}: {{ $purchase->formatted_purchase_date  }}</span><br>
                        <span class="cu-fs-16">{{ __('print.time') }}: {{ $purchase->format_created_time  }}</span><br>
                        @if($purchase->reference_no)
                        <span class="cu-fs-16">{{ __('print.purchase_bill_number') }}: {{ $purchase->reference_no  }}</span><br>
                        @endif
                    </td>
                </tr>
            </table>
