    ...
    <div class="invoice-container">
        ...
        <div class="invoice">
            ...
            <table class="addresses">
                <tr>
                    <td class="address">
                        <span class="fw-bold cu-fs-18">{{ __('print.order_from') }}</span><br>
                    ...
                    <td class="address">
                        <span class="fw-bold cu-fs-18">{{ __('print.order_status') }}</span> : <span>{{ $order->order_status }}</span>
            ...
            <tfoot>
                ...
                <tr>
                    <td colspan="{{ $noteColumns }}" rowspan="{{$noteRosSpan}}" class="tfoot-first-td">
                        <span class="invoice-note">{{ __('print.note') }}:<br></span>{{ $order->note }}
                    </td>
