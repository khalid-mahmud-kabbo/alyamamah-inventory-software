        ...
        <div class="invoice">
            <table class="header">
                <tr>
                    ...
                    <td class="bill-info">
                        <span class="bill-number">{{ __('print.bill') }} #: {{ $order->order_code }}</span><br>
                        <span class="cu-fs-16">{{ __('print.date') }}: {{ $order->formatted_order_date  }}</span><br>
                        <span class="cu-fs-16">{{ __('print.time') }}: {{ $order->format_created_time }}</span><br>
                        @if($order->due_date)
                        <span class="cu-fs-16">{{ __('print.due_date') }}: {{ $formatDate->toUserDateFormat($order->due_date)  }}</span>
                        @endif
                    </td>
                </tr>
            </table>
            ...
            <table class="addresses">
                <tr>
                    <td class="address">
                        <span class="fw-bold cu-fs-18">{{ __('print.order_to') }}</span><br>
            ...
            <tfoot>
                ...
                <tr>
                    <td colspan="{{ $noteColumns }}" rowspan="{{$noteRosSpan}}" class="tfoot-first-td">
                        <span class="invoice-note">{{ __('app.note') }}:<br></span>{{ $order->note }}
                    </td>
                ...
                @if(app('company')['is_enable_secondary_currency'])
                    <tr>
                        <td colspan="2" class="text-end fw-bold">{{ __('print.converted_to').'-'.$order->currency->code }}</td>
